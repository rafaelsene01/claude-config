...
**Quick mode is the only path that skips [Exploration](exploration.md).** If clarifying the task takes more than one exchange, or the answer opens new questions, it is not a quick task — escalate to the full pipeline and start with Exploration.
